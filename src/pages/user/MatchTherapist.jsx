...
const FindTherapist = () => {
  return (
    <>
      <div className="pt-15 flex flex-col md:flex-row min-h-screen">
        {/* Text Section */}
        <div className="w-full md:w-[40%] bg-[#F1F3F2] flex items-center px-6 md:px-12 py-10 md:py-0">
          <div className="w-full">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-[#005C65] text-left leading-tight">
            ...
            <div className="flex gap-4">
              <Link to="/search">
                <button className="bg-[#005C65] text-black px-6 py-3 rounded-xl font-semibold hover:bg-gray-200 transition w-full md:w-auto">
                  Let’s Get Started
                </button>
              </Link>
            </div>
        ...
        {/* Image Section */}
        <div className="w-full md:w-[60%] h-[300px] md:h-auto">
          <img
            src={Image}
            alt="man"
      ...
      <div className="max-w-6xl mx-auto p-4 flex flex-col md:flex-row gap-6 h-auto md:h-[500px] mt-10 mb-10">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center">
          <img
            ...
            className="w-full h-[250px] md:h-full object-contain rounded-lg"
          />
        </div>
        ...
        <div className="w-full md:w-1/2 bg-white bg-opacity-75 p-6 rounded-lg flex flex-col justify-between">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-[#005C65] mb-4 leading-snug">
              Quality mental health care within reach
            </h1>
            <p className="text-[#4cbac4] mb-4 text-lg md:text-xl">
            ...
            <p className="text-[#376468] mb-6 text-lg md:text-xl">
